...
abstract class User implements _i1.TableRow<int?>, _i1.ProtocolSerialization {
  ...
  factory User.fromJson(Map<String, dynamic> jsonSerialization) {
    return UserImplicit._(
      ...
      $_experienceAttendeesExperienceId:
          jsonSerialization['_experienceAttendeesExperienceId'] as int?,
    );
  }
  ...
  final int? _experienceAttendeesExperienceId;
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (_experienceAttendeesExperienceId != null)
        '_experienceAttendeesExperienceId': _experienceAttendeesExperienceId,
    };
  }
...
class _UserImpl extends User {
  ...
  User copyWith({
    ...
    return UserImplicit._(
      ...
      $_experienceAttendeesExperienceId: this._experienceAttendeesExperienceId,
    );
  }
}
...
class UserImplicit extends _UserImpl {
  UserImplicit._({
    ...
    DateTime? createdAt,
    required String profilePhotoUrl,
    int? $_experienceAttendeesExperienceId,
  })  : _experienceAttendeesExperienceId = $_experienceAttendeesExperienceId,
        super(
          id: id,
          userInfoId: userInfoId,
...
class UserTable extends _i1.Table<int?> {
  UserTable({super.tableRelation}) : super(tableName: 'user') {
    ...
    $_experienceAttendeesExperienceId = _i1.ColumnInt(
      '_experienceAttendeesExperienceId',
      this,
    );
  }
  ...
  late final _i1.ColumnInt $_experienceAttendeesExperienceId;
