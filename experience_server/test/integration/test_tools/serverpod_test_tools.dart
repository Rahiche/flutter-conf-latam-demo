...
import 'package:experience_server/src/generated/model/category.dart' as _i4;
import 'package:experience_server/src/generated/model/experience.dart' as _i5;
import 'package:experience_server/src/generated/model/user.dart' as _i6;
import 'package:experience_server/src/generated/protocol.dart';
import 'package:experience_server/src/generated/endpoints.dart';
...
class _ExperienceEndpoint {
  ...
  _i3.Future<List<_i5.Experience>> getExperiences(
    _i1.TestSessionBuilder sessionBuilder, {
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        ...
        var _localReturnValue = await (_localCallContext.method.call(
          _localUniqueSession,
          _localCallContext.arguments,
        ) as _i3.Future<List<_i5.Experience>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<List<_i5.Experience>> getExperiencesByCategory(
    _i1.TestSessionBuilder sessionBuilder, {
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
        endpoint: 'experience',
        method: 'getExperiencesByCategory',
      );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'experience',
          methodName: 'getExperiencesByCategory',
  ...
  _i3.Future<_i5.Experience> getExperience(
    _i1.TestSessionBuilder sessionBuilder,
    int experienceId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          ...
          parameters: _i1.testObjectToJson({'experienceId': experienceId}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue = await (_localCallContext.method.call(
          _localUniqueSession,
          _localCallContext.arguments,
        ) as _i3.Future<_i5.Experience>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<bool> registerAttendance(
    _i1.TestSessionBuilder sessionBuilder,
    int experienceId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
  ...
  _i3.Future<bool> unregisterAttendance(
    _i1.TestSessionBuilder sessionBuilder,
    int experienceId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
        endpoint: 'experience',
        method: 'unregisterAttendance',
      );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'experience',
          methodName: 'unregisterAttendance',
          parameters: _i1.testObjectToJson({'experienceId': experienceId}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue = await (_localCallContext.method.call(
