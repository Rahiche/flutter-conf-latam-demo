...
CREATE TABLE "review" (
    ...
    "_experienceReviewsExperienceId" bigint
);
...
CREATE TABLE "user" (
    ...
    "_experienceAttendeesExperienceId" bigint
);
...
ALTER TABLE ONLY "user"
    ...
    FOREIGN KEY("_experienceAttendeesExperienceId")
    REFERENCES "experience"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('experience', '20250902062111680', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20250902062111680', "timestamp" = now();
